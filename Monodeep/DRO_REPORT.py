...
calls["VISIT_FLAG"] = np.where(calls['Visit Status']=='Meet happened & Pitch completed',1,
                               np.where(calls['Visit Status']=='Doctor Unavailable',1,
                                     np.where(calls['Visit Status']=='Available but asks to come back later',1,0)))   
                               

df_V1 = calls[calls['Scheduled By']!='Aditya Rao']
df_V2 = df_V1[df_V1['Scheduled By']!='Mithun Test']
...
df_V2.to_csv('DRO_REPORT.csv',index = False)
