...
where
c.consult_datetime >= '2024-04-01' AND c.patient_attendance_status ='show' AND url.lead_source = 'Digital'
"""
...
df_csv.to_csv('Digital_OPD.csv',index=False)
...
csvFile = 'Digital_OPD.csv'  # Please set the filename and path of csv file.
